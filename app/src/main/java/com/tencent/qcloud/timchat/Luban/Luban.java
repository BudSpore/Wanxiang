package com.tencent.qcloud.timchat.Luban;
...
import static com.tencent.qcloud.timchat.Luban.Preconditions.checkNotNull;
...
public class Luban {
    ...
    public Luban launch() {
Log.d("error","the image file cannot be null, please call .load() before this method!");
